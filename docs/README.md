...
1. **[Manual de Flexbox Chess](file:///d:/repos/new/flexbox_chess/docs/manual_flexbox_chess.md)**
...
2. **[Especificación de Requerimientos del Sistema (SRS)](file:///d:/repos/new/flexbox_chess/docs/requerimientos_sistema.md)**
...
3. **[Especificación Técnica de la API: REST y WebSockets](file:///d:/repos/new/flexbox_chess/docs/especificacion_api_rest_websocket.md)**
...
4. **[Guía de Integración Frontend <-> API](file:///d:/repos/new/flexbox_chess/docs/guia_integracion_frontend.md)**
...
5. **[Inteligencia Artificial y Arquitectura Multi-Sesión](file:///d:/repos/new/flexbox_chess/docs/ia_y_multisesion.md)**
...
6. **[Bitácora de Cambios y Diagramas de Arquitectura](file:///d:/repos/new/flexbox_chess/docs/bitacora_cambios_y_arquitectura.md)**
